      ...
      <Container>
        <Flex className="bg-[#F8F6FE] py-[86px] px-12 rounded-[20px]">
          <div className="w-[540px] bg-[#F8F6FE]">
            ...
            <h4 className="w-[387px] text-[34px] text-dark font-inter font-semibold pt-4">
          ...
          <div className="w-[780px]">
            <Flex className="justify-between">
              ...
              <div>
                ...
                <a className="text-[20px] text-primary font-inter font-medium underline" href="">See Works</a>
              </div>
            </Flex>
          </div>
        </Flex>
